...
class RequestLimits:
    ...
    def can_add_pdf(self, file_id: str, size_mb: float, page_count: int) -> bool:
        ...
        if self.total_pdf_size_mb + size_mb > MAX_PDF_SIZE_MB or self.total_pdf_pages + page_count > MAX_PDF_PAGES:
            return False
    ...
    for msg in slack_messages:
        ...
        for file_info in files:
            ...
            if filetype == "pdf":
                ...
                logger.info(
                    f"Adding PDF: {filename}, size={file_size_mb:.2f}MB, pages={page_count}, "
